...
if ($NumberOfInstances -eq "TripleInstances") {
 ...
 $path_to_launch_mySQL = "C:\jenkins-ws\da-remote-install\automatedDeployment\AD_perBuild\distributedLab_$buildNumber\launch_mySQL_Instance.ps1"
...
write-host "======== Start $Number_of_FC_Servers of FileCluster Instance for deployment and Testing  ========"
       &C:\jenkins-ws\da-remote-install\automatedDeployment\AD_perBuild\distributedLab_$buildNumber\launch_mySQL_Instance.ps1
...
[string]$firstPart= 'aws ec2 run-instances --image-id   ami-458d063d --count '
...
$path_to_launch_MP = "C:\jenkins-ws\da-remote-install\automatedDeployment\AD_perBuild\distributedLab_$buildNumber\launch_MP_Instance.ps1"
[string]$iam_Instance = ' --iam-instance-profile Name="EC2_CodeDeploy"'
...
[string]$firstPart= 'aws ec2 run-instances --image-id   ami-458d063d  --count 1'
...
write-host "======== Start $Number_of_MP_Servers of MP Instance for deployment and Testing  ========"
       &C:\jenkins-ws\da-remote-install\automatedDeployment\AD_perBuild\distributedLab_$buildNumber\launch_MP_Instance.ps1
sleep 15
...
$MyPath = "C:\jenkins-ws\da-remote-install\AD_perBuild\distributedLab_$buildNumber\distributedLab\doAlignShards.bat"
